...
public class Teenager extends Kid {
	...
	public Teenager(int X, int Y, String firstName, String lastName, String gender) {
	...
	public void characterInteraction(Person people) {
		...
		case (0): {
			// can only discuss
			// TODO interface graphique: les diffï¿½rentes possibilitï¿½s!
			if (energy >= 1) {
				discuss(people);
...
>>>>>>> master:GameObject/Teenager.java
